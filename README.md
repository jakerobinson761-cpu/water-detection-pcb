...
When I first completed the PCB the entire thing didn't work. I knew it didn't work because simply plugging in the USB didn't power the green LED, and putting the J2 connector's wires into water likewise didn't power the red LED or active buzzer. One thing I realized was that instead of soldering everything and then testing the PCB only after soldering each part, I could've instead soldered certain areas first and tested it component by component. Doing things this way would've been much easier to troubleshoot problems as they come up. 
